...
const Contact = () => {
  ...
  return (
    ...
    <div className="flex-1 max-w-xl items-center">
        <h2 className="font-bold text-3xl sm:text-5xl text-slate-700">Let's Create Something Amazing Together</h2>
        <p className="mt-5 text-md text-slate-600">If you’re looking for a web developer who’s passionate about creating exceptional digital experiences, I’d love to hear from you! Whether you need a brand-new website or a redesign of an existing one, I’m here to help you build a solution that’s perfect for your business.</p>
